...
public class TiendaTablaModel extends AbstractTableModel{

	private TiendaDAO tienda;
	private List<Tienda> datos = new ArrayList<>(); // sincronizar datos

	public void updateModel() throws DAOException, SQLException {
		datos = tienda.listaTodasLasTiendas();
	}

	public TiendaTablaModel(TiendaDAO tienda) {
		this.tienda = tienda;
	}
